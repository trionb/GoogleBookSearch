...
mongoose.connect(
  ...
  "mongodb://localhost/googleBookdb"
);

const bookSeed = [
  {
    title: "ASP.NET 2.0 Instant Results",    
    authors:"Imar Spaanjaars",
    synopsis: "ASP.NET 2.0 Instant Results helps you quickly create dynamic Web pages with ASP.NET 2.0. The book is centered around a dozen ready–to–use projects with all the code for all the projects included on the books CD–ROM – that you can use immediately. ASP.NET 2.0 Instant Results dives into working code so you can learn it rapidly. The book and projects are written for intermediate–level programmers with some .NET experience. The projects and book provide a quick start reference so you can use ASP.NET 2.0 immediately.",
    imageLinks:{
        smallThumbnail:"http://books.google.com/books/content?id=mlgYoYgeaUUC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api"},
    infoLink:"http://books.google.com/books?id=mlgYoYgeaUUC&dq=%22+searchTerm+%22&hl=&source=gbs_api",
    date: new Date(Date.now())
  },
  {
    title: "Medical and Health Related Sciences Thesaurus",
    authors:"National Institutes of Health (U.S.)",
    description: "Indexing terms used in CRISP (Computer Retrieval of Information on Scientific Projects) and in Research grants index. Alphabetical arrangement. Cross references under terms.",
    imageLinks: {
        smallThumbnail:"http://books.google.com/books/content?id=ax0d4SkCFjIC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api"},
    infoLink: "https://play.google.com/store/books/details?id=ax0d4SkCFjIC&source=gbs_api",
    date: new Date(Date.now())
  },
  {
